...
##		  (a plain `git commit` with no -m), fill it from $GIT_AUTO_MESSAGE. If git
##		  already pre-filled one (e.g. a `pull --no-ff` merge message), leave it.
##		  Either way, never block on an editor.
